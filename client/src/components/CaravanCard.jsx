 ...
 * @param {object} caravan - 카라반의 상세 정보 (name, dailyRate, photos, location)
 */
export default function CaravanCard({ caravan }) {
    ...
    return (
        // 카드 전체 컨테이너
        <div className="bg-white overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-xl">
            {/* 카라반 이미지 */}
